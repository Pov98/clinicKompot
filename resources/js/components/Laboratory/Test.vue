    ...
    <div class="wrapper">
        ...
        <div class="p-3">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item btn btn-primary" data-bs-toggle="modal" data-bs-target="#deleteconfirm">Default
                  Code</a>
              </li>
              <li>
                ...
                <div class="search-box-content">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_search">
                        <tbody>
                            <tr>
                                ...
                                <td width="90%">
                                    <input v-if="btn_save == true" :disabled="fasle" class="string_zen clear_text text" id="search_word_simei_s" maxlength="50"
                                        name="patient_name" size="50" type="text" tabindex="10003">

                                    <input v-else :disabled="true" class="string_zen clear_text text" id="search_word_simei_s" maxlength="50"
                                        name="patient_name" size="50" type="text" tabindex="10003">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="90%">
                                    <input class="string_zen clear_text text" id="search_word_simei_s" maxlength="50"
                                        name="patient_age" size="20" type="text" tabindex="10003">
                                </td>
                            </tr>
                    ...
                    <div class="search-box-footer">
                        ...
                        <div v-if="btn_save == true " class="button type2" id="uniform-undefined">
                            <span><i class="fa fa-save"
                            aria-hidden="true"></i> Save<input type="button" value="表 示" class="type2"
                            onclick="submit_first_form('/master/jusinsya/index')" style="opacity: 0; width: 54px;"
                            tabindex="10025">
                            </span>
                        </div>
          ...
          <div class="box-footer-pagination" style="text-align: left">
            <div class="pagination">
              <div class="pagination">
                <a  class="btn-radius bt-pn btn btn-sm show" href="#" data-bs-toggle="dropdown"
                                  ...
                                  <div class="ui-dialog-content" style="background-color: #fff;">
                                      ...
                                      <div class="modal-footer">
                                          <div class="button type2" id="uniform-undefined" data-bs-dismiss="modal" @click="cancel()">
                                              <span>No<input type="button" class="type2"  tabindex="10008" value="No" style="width: 89px; opacity: 0;">
                                              </span>
                                          </div>
                                          <div class="button type2" data-bs-dismiss="modal" @click="show_saveBtn()"><span>Yes</span></div>
                                      </div>
                                  </div>
                              </div>
                          </div>
