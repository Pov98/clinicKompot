<template >
      ...
      <div id="product">
        ...
        <div class="search-box mb-4">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_search" id="hover-table">
              <tbody>
                ...
                <tr>
                  ...
                  <td width="50%">
                    <input @change="autoUpdateProduct(form)" v-model="form.product_barcode"
                      class="string_zen_kana clear_text text input_text" style="width: 360px" type="text" />
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="50%">
                    <div class="dropdown d-flex">
                      ...
                      <router-link to="/test" class="btn-addnew">
                ...
                <tr>
                  ...
                  <td width="50%">
                    <!-- <select @change="autoUpdateProduct(form)" v-model="form.stock_unit_of_measure_code" class="form"
                      style="width: 360px">
                ...
                <tr>
                  ...
                  <td width="50%">
                    <!-- <select v-model="form.sup_code" @change="autoUpdateProduct(form)" class="form" style="width: 360px">
                    ...
                    <div class="dropdown d-flex">
                      ...
                      <div class="dropdown-menu each-drop-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <ul style="list-style: none" class="scrollable-menu">
                          <li v-for="suppliyer in suppliyers" :value="suppliyer.sup_code" @click="getproduct(suppliyer, form, 'suppliyer')">
                            <div class="menu-item">
                ...
                <tr>
                  ...
                  <td width="50%">
                    <!-- <select v-model="form.group_code" @change="autoUpdateProduct(form)" class="form"
                      style="width: 360px">
                      <option value="">Selete Suppliyer</option>
                    ...
                    <div class="dropdown d-flex">
                      ...
                      <div class="dropdown-menu each-drop-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <ul style="list-style: none" class="scrollable-menu">
                          <li v-for="graoup in graoups" :value="graoup.group_code" @click="getproduct(graoup, form, 'groupproduct')">
                            <div class="menu-item">
                ...
                <tr>
                  ...
                  <td width="50%">
                    <!-- <select v-model="form.cat_code" @change="autoUpdateProduct(form)" class="form" style="width: 360px">
                      <option value="">Selete Suppliyer</option>
                    ...
                    <div class="dropdown d-flex">
                      ...
                      <div class="dropdown-menu each-drop-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <ul style="list-style: none" class="scrollable-menu">
                          <li v-for="categor in category" :value="categor.cat_code" @click="getproduct(categor, form, 'category')">
                            <div class="menu-item">
                ...
                <tr>
                  ...
                  <td width="50%">
                    <!-- <select v-model="form.brand_code" @change="autoUpdateProduct(form)" class="form"
                      style="width: 360px">
                      <option value="">Selete Suppliyer</option>
                  ...
                  <td width="90%">
                    <div class="selector" id="inactivced">
                      ...
                      <select id="inactivced" name="inactivced" tabindex="10003" v-model="form.inactived"
                        @change="autoUpdateProduct(form)" style="min-width: 51px; opacity: 0; width: 80px">
          ...
          <div v-else class="col-md-4 search-box02 flo02 outline-input-img" id="flo02">
            <div class="box-img02">
              <img alt="Upload Image ..." :src="bassUrl+'/img/product/' + form.image_url" @click="choosePhoto"
        ...
        <!-- <div class="fil">
          ...
          <div class="selector" id="inactivced">
            ...
            <select id="inactivced" name="inactivced" tabindex="10003" style="min-width: 51px; opacity: 0; width: 100px;">
              <option>5</option>
              <option>10</option>
              <option>20</option>
              <option>30</option>
              ...
              <thead>
                ...
                <tr v-for="form_line in form_lines">
                  <th class="bg_img" style="justify-content: center; background-color: white">
                    ...
                    <img v-else :src="bassUrl+'/img/product/' + form_line.image_url" style="width: 50px; height: 40px" @click="choosePhoto" />
                  ...
                  <th>
                    ...
                    <div class="dropdown">
                      <button @click="getunit(form_line.product_no)" @onmouseout="prooductboom(form_line)"
                        class="dropdown-toggle string_zen clear_text text select-menu-button" type="button" id="dropdownMenuButton1"
                        data-bs-toggle="dropdown" aria-expanded="false" size="50" style="height: 19px;">
                  ...
                  <th>
                    <select @change="autoUpdate(form_line)" class="form" style="width: 80%">
                      <option value="No">No</option>
                      <option value="Yes">Yes</option>
                    </select>
                  </th>
  ...
  <div class="modal fade ui-modal" id="staticBackdropss" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div style="padding:0 70px 0 60px">
                  ...
                  <div class="col-container">
                    <div class="row2-col1 mg-top"
                      style="width: 65%;display: flex;flex-direction: row;">
                      <div class="clientlogo">
                        <img :src="bassUrl+'/img/product/' + form.image_url" alt="Sup" />
                      </div>
                      <div class="p-detial">
                        ...
                        <p class="p-mg info-pad">Unit Price : {{ form.unit_price }}</p>
                      </div>
                    </div>
                    ...
                    <table id="pr-tb">
                      <thead>
                        <tr class="p-bg">
                          ...
                          <th class="text-center" style="width:10em">Inactived</th>
                      ...
                      <tbody>
                        <tr v-for="(form_line, index) in form_lines" :key="index">
                          <td style="text-align: center; padding-left: 0 !important;">
                            <img v-if="form_line.image_url == null" src="img/icon-img_upload.png"
                              style="width: 50px; height: auto" @click="choosePhoto" />
                            <img v-else :src="bassUrl+'/img/product/' + form_line.image_url" style="width: 50px; height: 40px"
                              @click="choosePhoto" />
                          </td>
