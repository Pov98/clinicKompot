                ...
                <tr>
                  ...
                  <td colspan="3">
                    ...
                    <input style="width: 8%;" class="string_zen clear_text text" id="search_word_jigyosyo_group_name"
                      maxlength="50" name="search_word[jigyosyo_group_name]" type="text" tabindex="10014"
                      v-model="form.age">
                    Birthday
                ...
                <tr>
                  ...
                  <td width="32%">
                    <div class="gender situation">
                      <div class="radio radio-1" id="uniform-search_word_sizai_send_kbn_0" @click="getsex('single')"><span
                          class="checked"><input v-model="form.status" checked="checked" id="search_word_sizai_send_kbn_0"
                            name="search_word[sizai_send_kbn]" type="radio" value="0" tabindex="10000"
                            style="opacity: 0;"></span></div><label for="search_word_sizai_send_kbn_0">
                        <font style="vertical-align: inherit;">
...
export default {
  ...
  methods: {
    ...
    updateRegister(id) {
      console.log(id)
      axios.post("/api/v1/pateint/update/" + id, this.singlerow)
        .then(() => {
          this.singlerow = {}
          this.getRegister()
        })
